            ...
            <div class="admin-modal-body">
                <div class="form-grid">
                    ...
                    <div class="form-group-admin">
                        ...
                        <input type="text" name="icon" id="serviceIcon" required placeholder="مثال: fa-home">
                    </div>
                </div>
                <div class="form-group-admin">
                    <label>الوصف</label>
    ...
    if(confirm('هل أنت متأكد من حذف هذه الخدمة؟')) {
        $.ajax({
            ...
            success: function() {
                ...
                window.location.hash = 'panelServices';
                location.reload();
            },
            error: function() {
                showNotif('خطأ في النظام - لم يتم الحذف', 'error');
            }
        });
    }
}
...
window.handleServiceSubmit = function(e) {
    ...
    const isActive = $('#serviceIsActive').is(':checked') ? '1' : '0';
